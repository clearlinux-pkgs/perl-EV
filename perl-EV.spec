...
cp %{_builddir}/EV-4.32/COPYING %{buildroot}/usr/share/package-licenses/perl-EV/8ef1d59d0a0dbdae691da831bd9afb7cb7cdf5a1
cp %{_builddir}/EV-4.32/libev/LICENSE %{buildroot}/usr/share/package-licenses/perl-EV/10e633ee2e9f8a961554d0d579f03a1d0755ff3b
if test -f Makefile.PL; then
